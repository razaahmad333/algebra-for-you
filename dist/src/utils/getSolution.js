...
var findTypeOfSolution_1 = require("./equation/findTypeOfSolution");
var getSolution = function (coefficients1, coefficients2) {
    ...
    var typeOfSolution = (0, findTypeOfSolution_1.findTypeOfSolution)({ xFactor: xFactor, yFactor: yFactor, constFactor: constFactor });
