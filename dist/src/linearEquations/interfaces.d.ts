export declare const INFINITE_SOLUTION =
  "Infinite solutions, ( Consistent and Dependent)";
export declare const UNIQUE_SOLUTION =
  "Unique solution ( Consistent and Independent) ";
export declare const NO_SOLUTION =
  "No solution ( Inconsistent and Independent )";
...
export declare type ISolutionType =
  | IINFINITE_SOLUTION
  | IUNIQUE_SOLUTION
  | INO_SOLUTION;
